...
====================
Production-ready RSS feed collector for 33 Indian news outlets.
Covers right-leaning, left-leaning, and center publications.

Can be used two ways:
  1. Standalone : python save_indian_feeds.py
...
from models import Base, RSSArticle, FetchLog

# ── LOAD ENV VARIABLES ────────────────────────────────────────────
load_dotenv()

DB_HOST     = os.getenv("DB_HOST", "localhost")   # FIX: was hardcoded as 127.0.0.1
...
INDIAN_OUTLETS = {
    ...
    "OpIndia": {
        ...
        "feeds": ["https://www.opindia.com/feed/"]
    },
    "Swarajya": {
        "bias": "right", "country": "IN",
        "feeds": ["https://swarajyamag.com/feed"]
    },
    "Organiser": {
        "bias": "right", "country": "IN",
        "feeds": ["https://organiser.org/feed/"]
    },
    "Republic World": {
        "bias": "right", "country": "IN",
        "feeds": ["https://www.republicworld.com/rss.xml"]
    },
    "DNA India": {
        "bias": "right", "country": "IN",
        "feeds": [
    ...
    "The Sunday Guardian": {
        "bias": "right", "country": "IN",
        "feeds": ["https://www.sundayguardianlive.com/feed"]
    },
    "Zee News": {
        "bias": "right", "country": "IN",
        "feeds": [
    ...
    "Scroll.in": {
        "bias": "left", "country": "IN",
        "feeds": ["https://scroll.in/feed"]
    },
    "The Caravan": {
        "bias": "left", "country": "IN",
        "feeds": ["https://caravanmagazine.in/feed"]
    },
    "Newslaundry": {
        "bias": "left", "country": "IN",
        "feeds": ["https://www.newslaundry.com/feed"]
    },
    "The News Minute": {
        "bias": "left", "country": "IN",
        "feeds": ["https://www.thenewsminute.com/rss.xml"]
    },
    "Article 14": {
        "bias": "left", "country": "IN",
        "feeds": ["https://article-14.com/feed"]
    },
    "Alt News": {
        "bias": "left", "country": "IN",
        "feeds": ["https://www.altnews.in/feed/"]
    },
    "Maktoob Media": {
        "bias": "left", "country": "IN",
        "feeds": ["https://maktoobmedia.com/feed/"]
    },
    "The Leaflet": {
        "bias": "left", "country": "IN",
        "feeds": ["https://theleaflet.in/feed/"]
    },
    "The Citizen": {
        "bias": "left", "country": "IN",
        "feeds": ["https://www.thecitizen.in/rss/feed/all"]
    },
    ...
    "The Quint": {
        "bias": "center", "country": "IN",
        "feeds": ["https://www.thequint.com/feed"]
    },
    "BBC India": {
        "bias": "center", "country": "IN",
        "feeds": ["https://feeds.bbci.co.uk/news/world/asia/india/rss.xml"]
    },
    "Reuters India": {
        "bias": "center", "country": "IN",
        "feeds": ["https://feeds.reuters.com/reuters/INtopNews"]
    },
    "AP India": {
        "bias": "center", "country": "IN",
        "feeds": ["https://rsshub.app/apnews/topics/apf-india"]
    },
}
...
def save_article(session: Session, data: dict) -> bool:
    ...
    try:
        session.add(RSSArticle(
            ...
            # body_fetched defaults to False via the model — no need to set it here
        ))
        session.commit()
        return True
    except Exception:
    ...
    try:
        with Session(engine) as session:
            for feed_url in outlet_info["feeds"]:
                ...
                if not feed.entries:
                    log.warning(f"    [!] No entries found — feed may be empty or blocked")
                    continue
            ...
            # FIX: removed the redundant session.commit() here —
            # save_article() already commits per article, so this
            # second commit was unnecessary and undermined per-article rollback logic.
...
def print_summary():
    """Prints article counts per outlet in the database."""
    with Session(engine) as session:
        log.info(f"\n{'═' * 55}")
...
def run_collection():
    ...
    log.info("=" * 55)
    log.info(f"  Indian News RSS Feed Collector")
